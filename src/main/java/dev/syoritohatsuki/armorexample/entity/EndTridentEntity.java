package dev.syoritohatsuki.armorexample.entity;
...
public class EndTridentEntity extends PersistentProjectileEntity {

    public final static TrackedData<Byte> LOYALTY = DataTracker.registerData(EndTridentEntity.class, TrackedDataHandlerRegistry.BYTE);
    public final static TrackedData<Boolean> ENCHANTED = DataTracker.registerData(EndTridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private boolean dealtDamage;
    public int returnTimer;

    // For custom entity spawn. Required later
    public EndTridentEntity(World world, LivingEntity owner, ItemStack stack) {
        super(EntityType.TRIDENT, owner, world, stack, null);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public EndTridentEntity(World world, double x, double y, double z, ItemStack stack) {
    ...
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ItemsRegistry.END_TRIDENT);
    }
}
